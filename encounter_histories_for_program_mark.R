...
cdat[,4:13][cdat$"2006_dead"==1,]<-0
cdat[,6:13][cdat$"2007_dead"==1,]<-0
cdat[,8:13][cdat$"2008_dead"==1,]<-0
cdat[,10:13][cdat$"2009_dead"==1,]<-0
cdat[,12:13][cdat$"2010_dead"==1,]<-0

cdat$total <- apply(cdat[,2:13],1,sum)

cdat <- cdat[cdat$total>=1,]
...
write.table(enhist[,2], 'C:/Users/avanderlaar/Documents/GitHub/RMark/live_dead_enhist_clean.inp', row.names=F, col.names=F, quote=F)
